...
function SelectMerchant() {
  ...
  <div className="">Merchant Selected: <span className="text-green-500">{merchant.name}</span></div>
  <div>Router Address: <span className="text-blue-500">{merchant.routerAddress}</span></div>
  <div>Chain ID: <span className="text-yellow-500">{merchant.chainselector}</span></div>
</div>
